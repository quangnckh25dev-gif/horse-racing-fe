...
import RefereeRaceComplaintsPage from "./pages/referee/RefereeRaceComplaintsPage";
...
import BettingHistoryPage from "./pages/spectator/BettingHistoryPage";
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/referee/race-complaints"
            element={guard(["Referee"], <RefereeRaceComplaintsPage />)} />
          ...
          <Route path="/spectator/betting/history"
            element={guard(["Spectator"], <BettingHistoryPage />)} />
